...
def parseArguments():
    ...
    parser.add_argument(
        "--dataset_A_name",
        type=str,
        help="the name of dataset_A_name, the dataset of source images (default: pfd)",
        nargs="?",
        default="pfd",
        const="pfd",
    )
    parser.add_argument(
        "--dataset_B_name",
        type=str,
        help="the name of dataset_B_name, the dataset of target images (default: Cityscapes)",
        nargs="?",
        default="Cityscapes",
        const="Cityscapes",
    )
...
def quickEval(
    model_name, dataset_A_name, dataset_B_name, subset, repetition, model_path
):
