...
from feamgan.Experiment_Component.Models.Blocks.StreamResnetBlock import (
    StreamResnetBlock,
)
...
class FeaMGenerator(BaseNetwork):
    def __init__(self, backbone_config, content_nc, output_nc):
        ...
        fmiddle_first_layer = 8 * round(content_nc / 8.0)
        self.content_stream = Stream(
            ngf=nf,
            semantic_nc=content_nc,
            norm_S=norm_S,
            fmiddle_first_layer=fmiddle_first_layer,
        )
